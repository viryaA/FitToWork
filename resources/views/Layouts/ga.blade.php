                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul id="healthDropdown" class="list-unstyled collapse ps-3">
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') === 'absensi' ? 'active' : '' }}" href="{{ route('gas.show', ['absensi']) }}">
                                Absensi Kesehatan
                                </a>
                            </li>
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') == 'rekap' ? 'active' : '' }}" href="{{ route('gas.show', ['rekap']) }}">
                                Rekap Kehadiran
                                </a>
                            </li>
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') == 'resume' ? 'active' : '' }}" href="{{ route('gas.show', ['resume']) }}">
                                Resume 
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        data-bs-toggle="collapse" data-bs-target="#kecelakaanDropdown" aria-expanded="false">
                            <span><i class="fas fa-file-alt" style="margin-right: 15px;"></i> Laporan</span>
                            <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul id="kecelakaanDropdown" class="list-unstyled collapse ps-3">
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') === 'laporan_mahasiswa' ? 'active' : '' }}" href="{{ route('gas.show', ['laporan_mahasiswa']) }}">
                                Laporan Mahasiswa
                                </a>
                            </li>
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') === 'laporan_karyawan' ? 'active' : '' }}" href="{{ route('gas.show', ['laporan_karyawan']) }}">
                                Laporan Karyawan
                                </a>
                            </li>
                        </ul>
