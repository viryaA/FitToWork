                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul id="healthDropdown" class="list-unstyled collapse ps-3">
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') === 'absensi' ? 'active' : '' }}" href="{{ route('ukks.show', ['absensi']) }}">
                                Absensi Kesehatan
                                </a>
                            </li>
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') == 'rekap' ? 'active' : '' }}" href="{{ route('ukks.show', ['rekap']) }}">
                                Rekap Kehadiran
                                </a>
                            </li>
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') == 'resume_mahasiswa' ? 'active' : '' }}" href="{{ route('ukks.show', ['resume_mahasiswa']) }}">
                                Resume Mahasiswa
                                </a>
                            </li>
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') == 'resume_karyawan' ? 'active' : '' }}" href="{{ route('ukks.show', ['resume_karyawan']) }}">
                                Resume Karyawan
                                </a>
                            </li>
                        </ul>
