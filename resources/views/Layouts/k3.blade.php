                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul id="kecelakaanDropdown" class="list-unstyled collapse ps-3">
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') === 'laporan_mahasiswa' ? 'active' : '' }}" href="{{ route('k3s.show', ['laporan_mahasiswa']) }}">
                                Laporan Mahasiswa
                                </a>
                            </li>
                            <li>
                                <a class="btn btn-light btn-block mb-2 w-100 {{ Request::get('page') === 'laporan_karyawan' ? 'active' : '' }}" href="{{ route('k3s.show', ['laporan_karyawan']) }}">
                                Laporan Karyawan
                                </a>
                            </li>
                        </ul>
