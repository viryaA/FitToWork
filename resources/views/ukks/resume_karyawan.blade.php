...
<div class="content">
    <div class="d-flex align-items-center">
            ...
            <span class="mx-2">/</span>
            <span class="subheader">Resume Karyawan</span>
    </div>
    <div class="divider"></div>
    <div class="card mb-4">
        <div class="card-header" style="background-color: #007bff; color: white;">
            <i><strong>Mengirim Resume Ke Karyawan</strong></i>
        </div>
    </div>
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="bagian">Bagian <span class="required">*</span></label>
                        <select id="bagian" class="form-control" required>
                ...
                <div class="form-group">
                    <label for="namaMahasiswa">Nama Karyawan <span class="required">*</span></label>
                    <textarea id="namaMahasiswa" class="form-control" rows="1" placeholder="Masukkan Nama Mahasiswa" required></textarea>
                </div>
            </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="nim">Nomor Pokok Karyawan <span class="required">*</span></label>
                        <textarea id="nim" class="form-control" rows="1" placeholder="Masukkan NPK Karyawan" required></textarea>
                    </div>
                </div>
            </div>
            <hr class="my-4">
